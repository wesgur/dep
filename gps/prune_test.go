	...
	}{
		{
			...
			co: CascadingPruneOptions{
				...
				PerProjectOptions: map[ProjectRoot]PruneOptionSet{
					ProjectRoot("github.com/wesgur/dep"): {},
				},
			},
			results: map[ProjectRoot]PruneOptions{
				ProjectRoot("github.com/wesgur/dep"): PruneNestedVendorDirs,
			},
		},
		{
			name: "all overridden",
			...
			results: map[ProjectRoot]PruneOptions{
				ProjectRoot("github.com/wesgur/dep"): PruneUnusedPackages | PruneNonGoFiles | PruneGoTestFiles,
			},
		},
		{
			name: "all redundant",
